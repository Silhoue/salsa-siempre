                    ...
                    foreach( $post_types as $post_type_name )
                        {
                            ...
                            if ($post_type_name == 'post')
                                add_submenu_page('edit.php', "Zmień kolejność", "Zmień kolejność", $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                            elseif ($post_type_name == 'attachment')
                            ...
                            else
                                {
                                    if (!is_post_type_hierarchical($post_type_name))
                                        add_submenu_page('edit.php?post_type='.$post_type_name, "Zmień kolejność", "Zmień kolejność", $capability, 'order-post-types-'.$post_type_name, array(&$this, 'SortPage') );
                                }
                        }
                }
            ...
            function SortPage()
                {
                    ...
                    <div class="wrap">
                        ...
                        <h2><?php echo $this->current_post_type->labels->name . ' -  Kolejność' ?></h2>
                        ...
                        <p class="submit">
                            <a href="#" id="save-order" class="button-primary">Zapisz</a>
                        </p>
                            ...
                            jQuery(document).ready(function() {
                                ...
                                jQuery("#save-order").bind( "click", function() {
                                    ...
                                    jQuery.post( ajaxurl, { action:'update-custom-type-order', order:jQuery("#sortable").sortable("serialize") }, function() {
                                        jQuery("#ajax-response").html('<div class="message updated fade"><p>Zmiany zostały zapisane</p></div>');
